...
const Login = () => {
  ...
  return (
    <MaquetteLayout 
      ...
      desc="Point d'entrée selon le rôle — Administrateur · Médecin · Patient" 
      url="santeconnect.sn/connexion"
    >
      {/* CONTENEUR PRINCIPAL DU FORMULAIRE */}
      <div className="min-h-[calc(100vh-140px)] bg-[#FSF4EF] flex items-center justify-center p-4">
